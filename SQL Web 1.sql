...
CREATE TABLE usuarios.cuentas_bancarias (
...
CREATE TRIGGER trg_usuarios_cuentas_bancarias
...
--- ===========================================================================
--- ===========================================================================
-------- FALTA LO DE version y update en las tablas de aqui en adelante 
--- ===========================================================================
--- ===========================================================================
...
-- =========================
CREATE SCHEMA IF NOT EXISTS revison;
...
CREATE INDEX reportes_target_idx ON revision.reportes (target_tipo, target_id);

-- =========================
-- REWARD TIERS
-- =========================
CREATE TABLE campanas.reward_tiers (
...
CREATE INDEX reward_tiers_campaign_idx ON campanas.reward_tiers (campaign_id);

-- =========================
-- PLEDGES
-- =========================
CREATE TABLE campanas.pledges (
...
CREATE INDEX pledges_campaign_idx ON campanas.pledges (campaign_id);
CREATE INDEX pledges_donante_idx ON campanas.pledges (donante_id);
CREATE INDEX pledges_estado_idx ON campanas.pledges (estado);
...
-- PAYOUT BATCHES
-- =========================
CREATE TABLE contabilidad.payout_batches (
...
-- DESEMBOLSOS
-- =========================
CREATE TABLE contabilidad.desembolsos (
